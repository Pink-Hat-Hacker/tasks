 ...
 * quiz application that provides a way to change the type of a quiz 
 * question by pressing a button. Recall from the Objects task that 
 * Quiz Questions can come in either Multiple Choice or Short Answer.
